    ...
    <>
      <div className="whitespace-nowrap items-center mt-2 bg-transparent mb-6 max-h-[25vh] overflow-x-scroll overflow-y-hidden">
        {profiles.map((pr, index) => {
          return (
            <div className="inline-block p-3" key={pr}>
              <Image
                alt="image"
                width={128}
                height={128}
                ...
                className={` ${
                  avatar.index === index &&
                  "border-[3px] border-lprimary ease-linear duration-150 scale-[1.2] shadow-lg"
      ...
      {/* Hidden field to submit the selected profile path with the form */}
      <input
        type="hidden"
        name="profile"
